...
async function getWeather(city){
  ...
  try{
    ...
    //Aguarda a resposta da API ser concluída e, em seguida, converte a resposta em um objeto JavaScript utilizando o método json() da resposta. O resultado é armazenado na variável data.
    const data = await response.json();
    return data; //retorna os dados da previsão do tempo
  } catch(error){ //captura erros que possam acontecer
